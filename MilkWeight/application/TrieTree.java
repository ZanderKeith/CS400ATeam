 ...
 * first by year, then by month, then by date.  Each date holds an integer
 * value weight.
 * 
 */
public class TrieTree {
	...
	/**
	 *
	 * TrieTreeMonthNode -This class holds an array corresponding to 
	...
	/**
	 * This method adds a leaf with value weight under the correct date.
	 * If the leaf already exists, this method updates the weight.  This method
	 * uses normal human conventions for the day and month, no need to 
	 * worry about array indexing. So month = 1 and day = 1 means the date
	 * January 1st
	 * @param year
	 * @param month
	 * @param day
